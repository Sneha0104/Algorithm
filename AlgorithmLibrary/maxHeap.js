...
maxHeap.prototype = new Algorithm();
maxHeap.prototype.constructor = maxHeap;
maxHeap.superclass = Algorithm.prototype;
...
maxHeap.prototype.init = function(am)
{
	var sc = maxHeap.superclass;
	var fn = sc.init;
	fn.call(this,am);
	this.addControls();
	this.nextIndex = 0;
...
maxHeap.prototype.addControls =  function()
{
	...
	this.removeSmallestButton = addControlToAlgorithmBar("Button", "Remove Biggest");
	...
	this.buildHeapButton = addControlToAlgorithmBar("Button", "Build Heap");
	this.buildHeapButton.onclick = this.buildHeapCallback.bind(this);
}



maxHeap.prototype.createArray = function()
{
...
maxHeap.prototype.insertCallback = function(event)
{
	var insertedValue;
...
maxHeap.prototype.clearCallback = function(event)
{
...
maxHeap.prototype.reset = function()
{
	this.currentHeapSize = 0;
}

maxHeap.prototype.removeSmallestCallback = function(event)
{
...
maxHeap.prototype.removeSmallest = function(dummy)
{
	this.commands = new Array();
	...
	{
		this.cmd("SetText", this.descriptLabel1, "Heap is empty, cannot remove biggest element");
		return this.commands;
	}
...
maxHeap.prototype.buildHeapCallback = function(event)
{
	this.implementAction(this.buildHeap.bind(this),"");			
}

maxHeap.prototype.buildHeap = function(ignored)
{
	this.commands = [];
	this.clear();
...
maxHeap.prototype.insertElement = function(insertedValue)
{
	this.commands = new Array();
...
maxHeap.prototype.disableUI = function(event)
{
...
maxHeap.prototype.enableUI = function(event)
{
...
function init()
{
	...
	currentAlg = new maxHeap(animManag, canvas.width, canvas.height);
}
